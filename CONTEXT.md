...
| 03 | `stages/03_job_tracking/` | Move saved roles through Saved → Researching → Ready to apply | `/jobs` | no |
...
| 05 | `stages/05_applications/` | Track submitted applications, materials, contacts, deadlines | `/applications` | no |
